...
class Frame:
    ...
    def __init__(self,timeNow,aplication):
        '''
        Frame(timeNow,aplication)'''
        self.newSecond = True
        #- Frame stuffs
        self.counter = 0
        self.new = True
        self.width = 1 / aplication.fps
        self.timeNext = timeNow + self.width
        #- Frame stuffs
        self.fpsCounter = 0
        self.apsCounter = 0
        #- Actions per frame. It was much simpler to implement
        self.apf = aplication.aps/aplication.fps
    ...
    def update(self,timeNow,aplication):
        '''
        It aims to mantain the fps and aps constant
        Frame.update(timeNow,aplication)'''
        ...
        if timeNow>self.timeNext :
            ...
            if self.timeError<0 :
                ...
                self.timeError = .95
            if self.counter<aplication.fps-1 :
                self.counter += 1
            else :
                self.newSecond = True
                self.counter = 0
